    ...
    function receive(message) {
        ...
        ({
            ...
            "send": function () {
                ...
                // determine whether the response object
                // eventually responds to an isDef message.
                var isDef = Q.send(response, 'isDef');
                Q.when(isDef, function () {
                    // if it is a def, it will respond,
                    // don't set up a when listener on the other side,
                    // just forward events back to us
